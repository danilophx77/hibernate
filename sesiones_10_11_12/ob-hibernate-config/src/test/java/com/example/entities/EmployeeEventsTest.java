...
public class EmployeeEventsTest {
    ...
    @Test
    void preRemoveCar() {// lo mas normal seria
        // que desde el lado del empleado uno pueda desasociar el auto
        ...
        carDao.deleteById(car1.getId());// no se puede borrar ya que hay otra
        // tabla apuntando hacia este dato nos larga una excepcion
    }
}
