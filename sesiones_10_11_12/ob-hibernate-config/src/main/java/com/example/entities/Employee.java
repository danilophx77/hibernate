...
// getter y setter
     ...
     * Antes de crear. creacion no  actualizacion
     */
    @PrePersist
    ...
    }// se registra la fecha en el momento del alta del empleado
    @PreUpdate
    public void preUpdate() {
        System.out.println("preUpdate");
        this.setEditDate(LocalDateTime.now());
    }// se registra la ultima vez que se modifico los datos de tal empleado
