...
public class EmployeeDAOImpl implements EmployeeDAO {
    ...
    public List<EmployeeDTO> findAllProjection() {
        ...
        for (Object[] employee: employees) { //itera sobre el array buscando el id y el mail
    ...
    public Long count() {
        ...
        Long count = (Long) session.createQuery("select count(e) from Employee e").getSingleResult();//e: alias de empleado
    ...
    public List<Employee> findByAge(Integer age) {
        ...
        // Named Parameter este es el mas nombrado ya que es mas dificil de confundir
