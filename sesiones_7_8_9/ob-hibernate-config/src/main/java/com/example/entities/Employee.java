...
public class Employee implements Serializable {
    ...
    // @OneToOne(cascade = CascadeType.ALL) el tema de la cascada hay que tratarlo con cuidado ya que no se podra
    //borrar el dato si ese valor apunta a otro ojo ahi hay que desasociar  manualmente con una columna que quede null
    @OneToOne
...
//    @MapsId
    ...
    @OneToMany(cascade = CascadeType.ALL)//un empleado tiene varios coches
